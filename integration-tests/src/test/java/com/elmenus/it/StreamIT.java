...
public class StreamIT {
    ...
    public void helloWorld() throws Exception {
        String answer = await(basketService.hello("foo").invoke());
        assertEquals("Hello, foo!", answer);
        await(basketService.useGreeting("bar").invoke(new GreetingMessage("Hi")));
        String answer2 = await(basketService.hello("bar").invoke());
